...
export declare const MsgCheckers: {
    encode(message: MsgCheckers, writer?: Writer): Writer;
...
export declare const MsgCheckersResponse: {
    encode(_: MsgCheckersResponse, writer?: Writer): Writer;
