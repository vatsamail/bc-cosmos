...
type MsgCheckers struct {
	Creator string `protobuf:"bytes,1,opt,name=creator,proto3" json:"creator,omitempty"`
}

func (m *MsgCheckers) Reset()         { *m = MsgCheckers{} }
func (m *MsgCheckers) String() string { return proto.CompactTextString(m) }
func (*MsgCheckers) ProtoMessage()    {}
func (*MsgCheckers) Descriptor() ([]byte, []int) {
	return fileDescriptor_b89f7ca8d0309536, []int{2}
}
func (m *MsgCheckers) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgCheckers) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgCheckers.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgCheckers) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgCheckers.Merge(m, src)
}
func (m *MsgCheckers) XXX_Size() int {
	return m.Size()
}
func (m *MsgCheckers) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgCheckers.DiscardUnknown(m)
}

var xxx_messageInfo_MsgCheckers proto.InternalMessageInfo

func (m *MsgCheckers) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
type MsgCheckersResponse struct {
}

func (m *MsgCheckersResponse) Reset()         { *m = MsgCheckersResponse{} }
func (m *MsgCheckersResponse) String() string { return proto.CompactTextString(m) }
func (*MsgCheckersResponse) ProtoMessage()    {}
func (*MsgCheckersResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b89f7ca8d0309536, []int{3}
}
func (m *MsgCheckersResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgCheckersResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgCheckersResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgCheckersResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgCheckersResponse.Merge(m, src)
}
func (m *MsgCheckersResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgCheckersResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgCheckersResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgCheckersResponse proto.InternalMessageInfo
...
func (*MsgRejectGame) Descriptor() ([]byte, []int) {
	return fileDescriptor_b89f7ca8d0309536, []int{8}
}
...
func (*MsgRejectGameResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b89f7ca8d0309536, []int{9}
}
...
func init() {
	...
	proto.RegisterType((*MsgCheckers)(nil), "alice.checkers.checkers.MsgCheckers")
	proto.RegisterType((*MsgCheckersResponse)(nil), "alice.checkers.checkers.MsgCheckersResponse")
...
var fileDescriptor_b89f7ca8d0309536 = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	Checkers(ctx context.Context, in *MsgCheckers, opts ...grpc.CallOption) (*MsgCheckersResponse, error)
...
func (c *msgClient) Checkers(ctx context.Context, in *MsgCheckers, opts ...grpc.CallOption) (*MsgCheckersResponse, error) {
	out := new(MsgCheckersResponse)
	err := c.cc.Invoke(ctx, "/alice.checkers.checkers.Msg/Checkers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	Checkers(context.Context, *MsgCheckers) (*MsgCheckersResponse, error)
...
func (*UnimplementedMsgServer) Checkers(ctx context.Context, req *MsgCheckers) (*MsgCheckersResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Checkers not implemented")
}
...
func _Msg_Checkers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgCheckers)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).Checkers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/alice.checkers.checkers.Msg/Checkers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).Checkers(ctx, req.(*MsgCheckers))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *MsgCheckers) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgCheckers) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgCheckers) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgCheckersResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgCheckersResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgCheckersResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgCheckersResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgCheckers) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgCheckers: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgCheckers: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgCheckersResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgCheckersResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgCheckersResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
